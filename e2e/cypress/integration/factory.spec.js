describe("Factory", () => {
  ...
  describe("Una vez cargada la pagina", () => {
    ...
    it("debe mostrar los elementos de la pagina", () => {
      ...
      cy.get(".sign_in_form")
      cy.get(".sign_in_form_input").then(function($input){
          $input[0].setAttribute('value', 'Chinwewencha')
        })
        .should('have.attr', 'value', 'Chinwewencha')
      
      cy.get(".sign_in_form_button").wait(3000).click({ force: true })
      cy.wait(3000)


      cy.get(".factory_selector_container")
      cy.get(".factory_selector_form").find("h1").contains("Whale cum Chinwewencha! ")
      cy.get(".factory_selector_form_input").then(function($input){
      ...
      //cy.get(".factory_selector_form_button").click()
